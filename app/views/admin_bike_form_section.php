<section class="lg:col-span-2 rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
    ...
    <form method="post" enctype="multipart/form-data" class="mt-5 space-y-4" data-bike-admin-form>
        ...
        <div>
            <label for="price_czk" class="mb-1 block text-sm font-medium">Cena (Kč)</label>
        ...
        <div class="grid gap-4 sm:grid-cols-2">
            ...
            <div><label for="frame_size" class="mb-1 block text-sm font-medium">Velikost rámu</label><input id="frame_size" name="frame_size" type="text" class="w-full rounded-lg border border-slate-300 px-3 py-2 transition-colors" value="<?php echo e((string) $form['frame_size']); ?>" data-highlight-required></div>
            <div><label for="wheel_size" class="mb-1 block text-sm font-medium">Velikost kol</label><input id="wheel_size" name="wheel_size" type="text" class="w-full rounded-lg border border-slate-300 px-3 py-2 transition-colors" value="<?php echo e((string) $form['wheel_size']); ?>" data-highlight-required></div>
        ...
        <label class="flex items-center gap-2 rounded-lg border border-transparent px-3 py-2 text-sm transition-colors" data-highlight-required-checkbox><input type="checkbox" name="in_stock" value="1" <?php echo ((int) $form['in_stock'] === 1) ? 'checked' : ''; ?> data-highlight-required>Skladem</label>
